<template>
    ...
    <div>
        <div class="row gy-4">
            ...
            <div class="col-sm-6" v-for="post in authorPosts.data">
                <!-- post -->
                <div class="post post-grid rounded bordered">
                    ...
                    <div class="details">
                        ...
                        <h5 class="post-title mb-3 mt-3">
                            <inertia-link :href="route('post.single', `${post.slug}`)">{{ post.title }}</inertia-link>
                        </h5>
                    ...
                    <div class="post-bottom clearfix d-flex align-items-center">
                        ...
                        <div class="more-button float-end">
                            <inertia-link :href="route('post.single', `${post.slug}`)"><span
                                class="icon-options"></span></inertia-link>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- load more button -->
        <div class="text-center" style="margin-top: 60px" v-if="authorPosts && authorPosts.next_page_url">
...
<script>
    export default {
        ...
        mounted() {
            this.nextPageLink = this.authorPosts.next_page_url
        },
